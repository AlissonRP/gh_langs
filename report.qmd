...
```
Precisamos primeiro notar que existiam mais de 400 linguagens disponíveis  no gh até 2021, assim vamos avaliando  as top 5 linguagens e R[^1] em quantidade de repositórios 
...
Evidentemente não podemos esquecer de Python pois como vimos está no top 5 de linguagens mais repositórios disponíveis, atualmente  conta com vários pacotes para análise de dados, e é a principal linguagem para deep learning, então é claro que não poderia faltar a comparação com suas concorrentes nesse ramo. 
...
Como Python tem é de proposito geral,
