...
Vimos que issues decrescem a partir de 2017 monotonicamente de forma geral e também para as linguagens estudadas nessa subseção, a portanto nos informa quais as 5 linguagens mantiveram mais anos de crescimento após 2017
...
lagged[:, :lag] = @pipe ifelse.(lagged[:, :lag] .> 0, 1, 0);
@pipe lagged |>
      groupby(_, :name) |>
      combine(_, :lag => sum) |>
      ...
      first(_, 5)
```
Temos portanto 3 das 5 linguagens que tiveram 3 anos de crescimento de issues se comparado ao ano anterior, ou seja: nenhuma delas manteou-se crescente desde o começo.
